...
//
// Typical use after implanting P and B and running Anneal with solid
// activation:
//
//   C++
//   ---
...
template <typename NumericType, int D> class NetDoping {
...
#pragma omp parallel for
  ...
  NumericType lateralJunctionPosition(NumericType atDepth) const {
    ...
    return v.empty() ? std::numeric_limits<NumericType>::infinity() : v.front();
  }
